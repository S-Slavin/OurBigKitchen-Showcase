...
struct TestUtils {
    ...
    static func printCurrentState() {
        ...
        if (try? AuthService.shared.loadDataFromKeychain(key: "password_\(testEmail)")) != nil {
        ...
        if (try? AuthService.shared.loadDataFromKeychain(key: "reset_token_\(testEmail)")) != nil {
