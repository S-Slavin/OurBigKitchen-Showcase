...
@MainActor
class VolunteerViewModel: ObservableObject, @unchecked Sendable {
    ...
    let categories = [
        "All", "Kitchen", "Delivery", "Serving", "Cleaning", 
    ...
    func registerForOpportunity(_ opportunity: VolunteerOpportunity, name: String, email: String, phone: String, notes: String) {
        ...
        Task { @MainActor in
            do {
                let _ = try await StatsManager.shared.addVolunteerRegistrationAsync(registration)
