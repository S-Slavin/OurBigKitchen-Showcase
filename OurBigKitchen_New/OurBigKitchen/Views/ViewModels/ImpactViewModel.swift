...
public struct ImpactPost: Identifiable, Equatable, Sendable {
    ...
    public init(id: String, userId: String, date: Date, tags: [String], message: String, imageData: Data?, views: Int, shares: Int) {
        self.id = id
        self.userId = userId
        self.date = date
        self.tags = tags
...
public struct UserImpactStats: Sendable {
    public let totalImpacts: Int
    public let totalShares: Int
    public let totalViews: Int
    
    public init(totalImpacts: Int, totalShares: Int, totalViews: Int) {
