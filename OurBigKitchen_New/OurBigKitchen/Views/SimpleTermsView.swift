...
struct SimpleTermsView: View {
        ...
        NavigationView {
            GeometryReader { geometry in
                ZStack {
                    ...
                    .onAppear {
                        print("SimpleTermsView onAppear - TermsManager.hasAcceptedTerms: \(TermsManager.shared.hasAcceptedTerms)")
                    }
                }
            }
    ...
    private func acceptTerms() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            ...
            print("Terms accepted in TermsManager, hasAcceptedTerms: \(TermsManager.shared.hasAcceptedTerms)")
        }
    }
}
